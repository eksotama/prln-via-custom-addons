...
try:
    ...
    from via_jasper_report_utils.framework import register_report_wizard, wizard, dt
except ImportError:
    import openerp
    ...
    from openerp.addons.via_jasper_report_utils.framework import register_report_wizard, wizard, dt
...
class wizard(wizard):
    ...
    _attrs = {
        ...
        'from_dt': ("{'readonly': [('date_filter','!=','filter_date')],"
                    " 'required': [('date_filter','=','filter_date')]}"),
        'to_dt': ("{'readonly': [('date_filter','!=','filter_date')],"
                  " 'required': [('date_filter','=','filter_date')]}"),

        'from_period_id': ("{'readonly': [('date_filter','!=','filter_period')],"
                           " 'required': [('date_filter','=','filter_period')]}"),
        'to_period_id': ("{'readonly': [('date_filter','!=','filter_period')],"
                         " 'required': [('date_filter','=','filter_period')]}"),
        ...
        'from_period_id_2': ("{'readonly': [('date_filter_2','!=','filter_period')],"
                             " 'required': [('date_filter_2','=','filter_period')]}"),
        'to_period_id_2': ("{'readonly': [('date_filter_2','!=','filter_period')],"
                           " 'required': [('date_filter_2','=','filter_period')]}"),

        'from_dt_2': ("{'readonly': [('date_filter_2','!=','filter_date')],"
                      " 'required': [('date_filter_2','=','filter_date')]}"),
        'to_dt_2': ("{'readonly': [('date_filter_2','!=','filter_date')],"
                    " 'required': [('date_filter_2','=','filter_date')]}"),
    }
