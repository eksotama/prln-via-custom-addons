...
class cost_revaluation(osv.osv_memory):
...
class invoice_item(osv.osv_memory):
    _name = 'invoice.item'
    ...
    _columns = {
        ...
        'lot_id': fields.many2one('stock.production.lot', 'Lot#', required=True, help='Product lot number of Product.'),
